...
class GmcModel(keras.models.Model):
    ...
    def get_gmc_loss(self, embedding):
        """
        Return GMC loss function based on the received inputs of embeddings.
        :author: Joschka Strüber
        :return: GMC loss function with this layer's alpha and the training
            label's coexist counts.
        """
        def gmc_loss(y_true, y_pred):
            """
            ...
            dot_matrix = tf.matmul(tf.transpose(embedding), embedding)
